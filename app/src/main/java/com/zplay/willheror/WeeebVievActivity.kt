...
class WeeebVievActivity : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWeeebVievBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWeeebVievBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val first = "http://"
        val second = "wondroustreasure.xyz/go.php?to=2&"
